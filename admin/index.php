...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="setting/edit_header.php">Edit Header Title</a> 
        <a href="profil/edit_logo.php">Edit Logo</a> 
        <a href="setting/edit_footer.php">Edit Footer Details</a> 
        ...
        <a href="../user/index.php" style="margin-top: 20px;">Logout</a>
    </div>
