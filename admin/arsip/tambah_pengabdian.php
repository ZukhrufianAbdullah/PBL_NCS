...
<body>
    ...
    <div class="content">
        ...
        <form id="formPengabdian" method="POST" onsubmit="return validateForm('formPengabdian')">
            
            <fieldset>
                <legend>Informasi Pengabdian</legend>
                
                <div class="form-group">
                    <label for="judul_pengabdian">Judul Pengabdian <span style="color: red;">*</span></label>
                    <input type="text" id="judul_pengabdian" name="judul_pengabdian" required
                           placeholder="Masukkan judul pengabdian masyarakat">
                </div>
                
                <div class="form-group">
                    <label for="skema">Skema Pengabdian <span style="color: red;">*</span></label>
                    <select id="skema" name="skema" required>
                        <option value="">-- Pilih Skema --</option>
                        <option value="PKM">Program Kemitraan Masyarakat (PKM)</option>
                        <option value="PPM">Program Pemberdayaan Masyarakat (PPM)</option>
                        <option value="PPDM">Program Pengembangan Desa Mitra (PPDM)</option>
                        <option value="Mandiri">Mandiri</option>
                    </select>
                </div>
                
                <div class="form-group">
                    <label for="tahun">Tahun Pelaksanaan <span style="color: red;">*</span></label>
            ...
            <fieldset>
                <legend>Tim Pengabdian</legend>
                
                <div class="form-group">
                    <label for="id_ketua">Ketua Tim <span style="color: red;">*</span></label>
                ...
                <div class="form-group">
                    <label for="anggota">Anggota Tim (Opsional)</label>
                    <textarea id="anggota" name="anggota" rows="3"
                              placeholder="Tuliskan nama anggota tim (pisahkan dengan koma)"></textarea>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label for="mitra">Mitra/Lokasi Pengabdian</label>
                    <input type="text" id="mitra" name="mitra" 
                           placeholder="Nama mitra atau lokasi pengabdian">
                </div>
                
                <div class="form-group">
                    <label for="deskripsi">Deskripsi Kegiatan</label>
                    <textarea id="deskripsi" name="deskripsi" rows="6"
                              placeholder="Jelaskan ringkasan kegiatan pengabdian..."></textarea>
                </div>
                
                <div class="form-group">
                    <label for="sumber_dana">Sumber Dana</label>
                    <input type="text" id="sumber_dana" name="sumber_dana" 
                           placeholder="Contoh: DIKTI, Internal Politeknik">
                </div>
            </fieldset>
            ...
            <div class="form-group" style="padding: 0 20px;">
                ...
                <a href="edit_pengabdian.php" class="btn-secondary" 
